      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {[
            {
              title: "Arts",
              subjects: ["English Language","Literature in English", "Ndebele Language", "Heritage", "Family and Religious Studies", "History",],
              color: "bg-green-500"
            },
            {
              title: "Commercials",
              subjects: ["Mathematics","Principles of Accounts", "Business Enterprise Skills",],
              color: "bg-blue-500"
            },
            {
              title: "Sciences",
              streams: [
                {
                  name: "Pure Sciences",
                  subjects: ["Physics", "Chemistry", "Biology","Agriculture", "Geography"]
                },
                {
                  name: "Other Sciences",
                  subjects: ["Technical Drawing", "Computer Science", "Combined Science",]
                }
              ],
              color: "bg-purple-500"
            }
